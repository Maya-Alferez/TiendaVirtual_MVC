<html>
    ...
    <h1 class="titulo-principal">
        ...
        <div class="text-center">
            <h2 class="titulo titulo-enlace"><a href="/">Inicio</a>/ Guía de tallas</h2>
        </div>

        <section class="contenido-tallas">
            <div class="contenido-imagen">
                <picture>
                    <source srcset="../build/img/Guia_tallas.webp" type="image/webp">
                    <source srcset="../build/img/Guia_tallas.jpg" type="image/jpeg">
                    <img loading="lazy" src="../build/img/Guia_tallas.jpg" alt="guia tallas">
                </picture>
            </div>
        </section>
    ...
    <footer class="footer">
        ...
        <div class="reservado">
            All Rights Reserved by <span class="lab">catsphereLabs</span>
